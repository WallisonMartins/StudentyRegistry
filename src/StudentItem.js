    ...
    return (
      this.state.isEdit === true ? 
        <tr className="bg-warning" key={this.props.index}>
          ...
          <td><FaRegSave className="far fa-save" onClick={this.editStudentSubmit} /></td>
          <td><FaTrash  className="fas fa-trash" onClick={this.deleteStudent} /></td>
        </tr>
      :
        <tr key={this.props.index}>
          ...
          <td>{grade}</td>
          <td>{school}</td>
          <td><FaEdit className="far fa-edit" onClick={this.editStudent} /></td>
          <td><FaTrash className="fas fa-trash" onClick={this.deleteStudent} /></td>
        </tr>
    );
  }
